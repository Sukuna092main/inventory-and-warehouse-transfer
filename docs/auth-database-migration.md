...
**Trạng thái:** Entity và migration đã viết, kiểm tra thành công trên PostgreSQL; đang chờ bạn chạy migration vào schema `public` của `auth_db`.
